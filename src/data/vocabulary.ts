...
export const INITIAL_VOCABULARY: WordItem[] = [
  ...
  },
  {
    ...
    tip: '非直飛的中轉航班稱為 connecting flight 或 transfer flight。'
  },
  {
    id: 'vocab-104',
    word: 'bellhop',
  ...
  },
  {
    ...
    tip: '在許多美國餐廳，滴濾黑咖啡與碳酸飲料通常提供 free refills。'
  },
  {
    id: 'vocab-110',
    word: 'coupon',
    ...
    tip: '許多品牌官網或暢貨中心服務台會提供旅客專屬折價券手冊。'
  },
  {
    id: 'vocab-111',
    word: 'cashier',
  ...
  },
  {
    ...
    tip: '美國各州的 sales tax 稅率不同（有些州如奧勒岡州為 0% 免稅）。'
  },
  {
    id: 'vocab-113',
    word: 'gas station',
    ...
    tip: '美式稱 gas station，英式稱為 petrol station。'
  },
  {
    id: 'vocab-114',
    word: 'parking lot',
    ...
    tip: '英式常稱 car park；地下停車場常寫為 underground parking。'
  },
  {
    id: 'vocab-115',
    word: 'speed limit',
  ...
  },
  {
    ...
    tip: '在英國與澳洲，Cheers 除了碰杯乾杯，口語上極常當作「謝謝」或「再見」。'
  },
  {
    id: 'vocab-117',
    word: 'Count me in',
  ...
  },
  {
    ...
    category: 'emergency',
    categoryLabel: '緊急與醫療',
    example: 'Is there a 24-hour pharmacy nearby where I can get throat lozenges?',
    exampleTranslation: '請問這附近有 24 小時營業可以買到喉糖的藥局嗎？',
    tip: '在英國與澳洲常稱 chemist，在美國常稱 drugstore 或 pharmacy。'
  },
  {
    id: 'vocab-120',
    word: 'diarrhea',
    phonetic: '/ˌdaɪəˈriːə/',
    phoneticUk: '/ˌdaɪəˈrɪə/',
    partOfSpeech: 'n.',
    translation: '腹瀉 / 拉肚子',
    category: 'emergency',
    categoryLabel: '緊急與醫療',
    example: 'I have had bad diarrhea since drinking that tap water.',
    exampleTranslation: '喝了那杯生水之後，我就一直在嚴重拉肚子。',
    tip: '向藥局求助止瀉藥時可說 "I need something for diarrhea"。'
  }
];
